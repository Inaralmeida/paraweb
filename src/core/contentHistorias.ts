...
export const contentHistorias: IContetHistorysProps[] = [
  {
    id: "um",
    title: "Daniel Dias",
    titlePage: "daniel-dias",
    interviewed: "Daniel Dias",
    photoInterviewed: "/historias/historiasDeVida_EntrevistadoDaniel.jpg",
    descriptionsPhotoInterviewed:
      "Imagem do Daniel Dias sorrindo durante uma palestra. Ele utiliza camisa social preta e microfone auricula",
    headline:
    ...
    text: [
      ...
      `Seu primeiro contato com o esporte foi aos 16 anos, após acompanhar Clodoaldo Silva – um dos principais nomes da modalidade – conquistando medalhas para o Brasil durante os Jogos Paralímpicos de Atenas, em 2004. Mais à frente, Daniel passou a colecionar medalhas paralímpicas, de Parapan-americanos, e alguns prêmios como o Laureus, um troféu concedido anualmente aos esportistas de maior destaque durante o ano anterior. `,
      `Com mais de uma década atuando no esporte de alto rendimento, Dias, atualmente com 35 anos de idade e aposentado das piscinas, é hoje dono do IDD (Instituto Daniel Dias), que trabalha diretamente na busca pela inclusão social por meio do esporte. Ele acredita que, através de seu projeto, pode impactar diretamente a vida social e profissional de várias crianças com alguma deficiência, deixando assim não apenas um legado esportivo para a sociedade, mas também de transformação nas famílias de todos os envolvidos.`,
      `Ao Relatos Paralímpicos, o ex-nadador, que ainda detém o recorde mundial nas provas de 100m e 200m de nado peito, 100m de costas e 200m de borboleta, fala sobre infância, carreira, aposentadoria e revela também, com exclusividade, a história mais marcante de sua vida.`,
  ...
  },
  {
    ...
    headline:
      "Campeã mundial e medalhista Parapan-americana e paralímpica, a velocista brasileira, que sofreu um AVC na adolescência, revela como o paradesporto foi essencial na sua mudança de vida ",
    phraseImpact: "O atletismo acabou virando parte da minha reabilitação",
    nameAuthor: "Laís Gonella",
    linkPodcast: "/historias/pdcVeronica.mp3",
    ...
    text: [
      ...
      `Alvo de olhares preconceituosos, Verônica relata que o amor pelo atletismo veio após algumas negativas. Ela não gostava da modalidade, mas bastou seu pai levá-la a um festival para que essa chave virasse. `,
      `A atleta também conta que já praticou mais de 10 modalidades esportivas diferentes e até mesmo já pagou alguns micos em competições com a presença de familiares. "Eu pratiquei de tudo o que você possa imaginar. E eu gostava de tudo, mas não significava que eu era a melhor atleta do mundo. Pelo contrário, na natação, por exemplo, a minha mãe chegou a parar uma competição achando que eu estava me afogando, mas na verdade eu estava fazendo o nado cachorrinho”, brincou. `,
      `Pensando sempre à frente, Verônica foca sua trajetória em realizações de sonhos e um deles se materializou em 2019, quando ela criou o Time Naurú, uma equipe de atletismo paralímpico para disputar as competições regionais e nacionais organizadas pelo Comitê Paralímpico Brasileiro. Além de competir pela equipe, ela assumiu o papel de gestora, com apenas 24 anos, já projetando as possibilidades futuras no paradesporto pós-aposentadoria. `,
      `Ao Relatos Paralímpicos, a multicampeã conta que é movida por sonhos e que os próximos sempre são alimentados por conquistas futuras, como os Jogos Paralímpicos de Paris em 2024, que são projetados como os maiores da Era Moderna. `,
      `Abaixo você pode escutar o episódio completo, que tem roteiro e apresentação de Laís Gonella.`,
    ],
  },{
    id: "dois",
    ...
    nameAuthor: "Laís Gonella",
    linkPodcast: "/historias/pdcArthur.mp3",
