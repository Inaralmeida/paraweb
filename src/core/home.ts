export const homeData = [
  ...
  },
  {
    ...
    preview:`A representação feminina no esporte paralímpico exerce um papel essencial ao quebrar estereótipos, estimular a equidade de gênero e servir como fonte de inspiração para pessoas ao redor do mundo. Confira as entrevistas para saber mais.`,
    by:`Rebeca Barreto da Silva`,
  ...
  {
    title:`TECNOLOGIA`,
    preview:`A tecnologia desempenha um papel crucial no esporte paralímpico, beneficiando tanto a vida pessoal dos atletas quanto seu desempenho esportivo. A evolução tecnológica tem contribuído para avanços significativos na fisioterapia, proporcionando cuidados aprimorados. Confira as entrevistas realizadas e entenda mais sobre o assunto.`,
    by:`Leandro Fazano Cardoso`,
    image:`/banners/banner_tecnologia.jpg`,
